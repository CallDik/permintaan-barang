...
-- ============================================================
-- UPDATE: Tambah kolom batas_pengajuan_ulang di master_alat_kantor
-- ============================================================
ALTER TABLE `master_alat_kantor`
    ADD COLUMN IF NOT EXISTS `batas_pengajuan_ulang` INT NOT NULL DEFAULT 0 AFTER `stok`;

-- 0 = tidak ada batas (bebas ajukan kapan saja)
